...
//
//    @Autowired
//    private com.example.eurder.repositories.ItemRepository itemRepository;
//
//
//    private com.example.eurder.Repositories.OrderRepository orderRepository;
//
//    @Autowired
...
//
//        List<ReservedOrder> listOfAllReservedOrdersOfUser = reservedOrderRepository.findReservedOrderByPerson_IdWhereOrder_IDIsNull(member1.getUserId());
//
//        double totalPrice = reservedOrderService.getTotalPrice(listOfAllReservedOrdersOfUser);
